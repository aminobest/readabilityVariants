...
public class Const {
	...
	public static final String CF_ALRD = "the travel card is already checked-in";
	
	
	public static final String CF_LB = "the travel card balance is too low";

	
	public static final String CS = "the travel card is checked-in";
